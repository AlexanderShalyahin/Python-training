...
#/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#598. На вхід програми подається рядок, що містить слова, розділені пропуском. Програма повинна вивести статистику довжин слів в отриманому рядку,
# від меншої довжини слова до більшої. Словом вважається послідовність довільних символів, оточена пропусками або межами рядка.
# Зауважте, що розділові знаки також відносяться до слова. Користувач вводить один рядок, що містить послідовності англійських символів і знаків пунктуації,
# розділені пропуском. Для кожної довжини слова, що зустрічається в заданому рядку, потрібно вказати кількість слів з такою довжиною у форматі «довжина: кількість».
# Статистика повинна виводитися в порядку збільшення довжини.
...
#         some_dict[i] +=1
#
# for l, num in sorted(some_dict.items()):
#     print(f'{l}: {num}')
#/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#599. На вхід програми подається рядок, який містить одне ціле число n - кількість англійських слів у англійсько-латинському словнику,
# за якими йдуть n перекладів цих слів. Кожен запис міститься в окремому рядку, що містить перше англійське слово, потім дефіс, оточений пропусками,
# а потім розділений комами список з перекладами цього англійського слова на латинській мові. Всі слова складаються лише з англійських літер.
# Переклади сортуються в лексикографічному порядку. Порядок англійських слів у словнику також лексикографічний.
# Надрукуйте відповідний латинсько-англійський словник у тому ж форматі (кількість слів та їхні переклади).
# Зокрема, першим у рядку слів має бути лексикографічно мінімальний переклад латинського слова, потім другого в цьому порядку і т. д.
# Англійські слова в кожному рядку також слід сортувати лексикографічно.
# num = int(input('Enter: '))
# latin_english_dictionary = {}
#
# for _ in range(num):
...
#
#     for latin_word in k:
#         if latin_word in latin_english_dictionary:
#             latin_english_dictionary[latin_word] += [v[0]]
#         else:
#             latin_english_dictionary[latin_word] = [v[0]]
#
# print(len(latin_english_dictionary))
# for lat, eng in sorted(latin_english_dictionary.items()):
#     print(lat, '-', *sorted(eng))
#/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#600. Дано текст в рядку. Виведіть слово, яке в цьому тексті зустрічається найчастіше. Якщо таких слів кілька, виведіть те, яке менше в лексикографічному порядку.
# cities = 'Tokyo Seoul London Sofia Tokyo Sydney London'
# cities_dict = {city: cities.split().count(city) for city in cities.split()}
# lst_cities = [city for city, count in cities_dict.items() if count == max(cities_dict.values())]
# print(sorted(lst_cities)[0])
#/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#601. Кожен з n школярів деякої школи знає m мов. Визначте, які мови знають всі школярі і мови, які знає хоча б один з школярів.
# Перший рядок вхідних даних містить кількість школярів n. Далі йде n чисел m, після кожного з чисел йде m рядків, що містять назви мов, які знає i-й школяр.
# Довжина назв мов не перевищує 1000 символів, кількість різних мов не більше 1000 (1 ≤ n ≤ 1000, 1 ≤ m ≤ 500).
# У першому рядку виведіть кількість мов, які знають усі школярі. Починаючи з другого рядка - список таких мов.
# Потім - кількість мов, які знає хоча б один школяр, на наступних рядках - список таких мов.
